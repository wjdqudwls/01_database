...
-- 문제 : 메뉴 가격이 13000원인 메뉴의
-- 메뉴명, 가격을 메뉴명 내림 차순으로 조회
SELECT
    menu_name,
    menu_price
FROM
...
-- 메뉴 가격이 5000원 미만 또는 2만원 이상인 메뉴의
-- 메뉴명, 메뉴 가격을
-- 메뉴 가격 오름차순으로 조회
...
FROM
    tbl_menu
WHERE
    (category_code = 4 OR menu_price = 9000) AND menu_code > 6;